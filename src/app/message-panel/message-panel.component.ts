...
import { Message, MessagePessoa } from '../utility/constants';
...
export class MessagePanelComponent {
  ...
  //private _messages: MessagePessoa[] = [];

  userPath = "../../assets/image/user-path.png"
  avatarPath = "../../assets/image/bot-path.png"
